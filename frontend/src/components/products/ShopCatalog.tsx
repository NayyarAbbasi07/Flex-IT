      ...
      <div className="mb-6 flex flex-col gap-3 sm:mb-8 sm:flex-row sm:items-center">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="h-11 w-full rounded-xl border border-border bg-card pl-10 pr-4 text-sm outline-none transition focus:border-foreground focus-ring"
        ...
        <div className="flex gap-2">
          <select
            ...
            className="h-11 rounded-xl border border-border bg-card px-3 text-sm outline-none focus:border-foreground focus-ring"
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <label className="block text-sm">
              ...
              <select
                ...
                className="h-10 w-full rounded-lg border border-border bg-card px-3 text-sm focus-ring"
              >
