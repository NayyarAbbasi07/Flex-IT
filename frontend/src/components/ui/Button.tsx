...
const variants: Record<ButtonVariant, string> = {
  primary:
    "bg-neutral-900 text-white hover:bg-neutral-800 shadow-sm dark:bg-neutral-100 dark:text-neutral-900 dark:hover:bg-neutral-200",
  secondary:
  ...
  whatsapp:
    "bg-[#075E54] text-white hover:bg-[#064E46] shadow-sm",
};
