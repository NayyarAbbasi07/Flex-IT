...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "Tap Buy on WhatsApp on any product. A pre-filled message opens with the product name, size, price, condition, reference code, and a link to that shoe. Confirm availability with us and we'll guide you through payment and delivery.",
  },
  {
    id: "3",
