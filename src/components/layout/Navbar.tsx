    ...
    >
      <Container className="flex h-16 items-center justify-between md:h-20">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-border bg-white/60 text-foreground transition hover:bg-muted focus-ring lg:hidden"
